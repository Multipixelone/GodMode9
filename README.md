...
* Place `GodMode9.bin`(from the release archive) to into `sd:/luma/payloads/`
...
You may now run GodMode9 via holding the start button on startup and selecting `GodMode9.bin` from the Luma3DS Chainloader select menu. See below for a list of stuff you can do with it.
